...
{
    protected $signature = 'interchange:sample {post=1 : The JSONPlaceholder post id to fetch}';
    ...
    public function handle(): int
    {
        ...
        try {
            $post = Interchange::driver('sample')
                ->showPost()
                ->withPathParam('id', $id)
                ->send()
                ->json();
        ...
        $comments = Interchange::driver('sample')->commentsFor($id);
        ...
        $created = Interchange::driver('sample')
